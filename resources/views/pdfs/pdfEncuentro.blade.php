                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                            <div class="flex items-center">
                                <div class="flex-shrink-0 w-10 h-10">
                                    <img class="w-full h-full rounded-full" src="{{public_path($encuentro['equipo_local']->imagen)}}" alt="Imagen Del Equipo Local" />
                                </div>
                        ...
                        <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                            <div class="flex items-center">
                                <div class="flex-shrink-0 w-10 h-10">
                                    <img class="w-full h-full rounded-full" src="{{public_path($encuentro['equipo_visitante']->imagen)}}" alt="Imagen Del Equipo Visitante" />
                                </div>
                            ...
                            <div class="flex items-center">
                                <div class="flex-shrink-0 w-10 h-10">
                                    <img class="w-full h-full rounded-full"
                                        src="{{public_path($encuentro['sede']->imagen)}}"
